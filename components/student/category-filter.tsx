...
export function CategoryFilter({ onCategoryChange, selectedCategoryId, dailyMenuItems }: CategoryFilterProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute left-0 top-0 h-full w-12 bg-gradient-to-r to-transparent pointer-events-none" />
      <div className="absolute right-0 top-0 h-full w-12 bg-gradient-to-l to-transparent pointer-events-none" />
